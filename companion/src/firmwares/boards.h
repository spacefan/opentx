...
#define IS_TARANIS_X9LITE(board)       (board==Board::BOARD_TARANIS_X9LITE || board==Board::BOARD_TARANIS_X9LITES)
#define IS_TARANIS_X9LITES(board)      (board==Board::BOARD_TARANIS_X9LITES)
